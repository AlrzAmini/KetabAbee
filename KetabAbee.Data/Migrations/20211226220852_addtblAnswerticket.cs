...
{
    public partial class addtblAnswerticket : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketAnswers", x => x.AnswerId);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_TicketAnswers_Users_SenderId",
                        column: x => x.SenderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketAnswers_SenderId",
                table: "TicketAnswers",
                column: "SenderId");
