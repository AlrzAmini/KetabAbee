...
namespace KetabAbee.Data.Migrations
{
    ...
    [Migration("20220408140219_addusernametoanswer")]
    partial class addusernametoanswer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KetabAbee.Domain.Models.Audio_Book.DownloadedAudioBook", b =>
                {
                    ...
                    b.ToTable("DownloadedAudioBooks");
                });

            modelBuilder.Entity("KetabAbee.Domain.Models.Audio_Book.Q_And_A.ABook_QAnswer", b =>
                {
                    ...
                    b.ToTable("ABookQAnswers");
                });

            modelBuilder.Entity("KetabAbee.Domain.Models.Audio_Book.Q_And_A.ABook_Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ABookQuestions");
                });

            modelBuilder.Entity("KetabAbee.Domain.Models.Banner.Banner", b =>
                {
            ...
            modelBuilder.Entity("KetabAbee.Domain.Models.Blog.BlogView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("KetabAbee.Domain.Models.Products.CompareItem", b =>
                {
                    b.Property<int>("CompareItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("KetabAbee.Domain.Models.Audio_Book.Q_And_A.ABook_QAnswer", b =>
                {
                    b.HasOne("KetabAbee.Domain.Models.Audio_Book.Q_And_A.ABook_Question", "Question")
                        .WithMany("ABookQAnswers")
            ...
            modelBuilder.Entity("KetabAbee.Domain.Models.Blog.BlogView", b =>
                {
                    b.HasOne("KetabAbee.Domain.Models.Blog.Blog", "Blog")
                        .WithMany("Views")
            ...
            modelBuilder.Entity("KetabAbee.Domain.Models.Audio_Book.AudioBook", b =>
                {
                    b.Navigation("AudioBookQuestions");
